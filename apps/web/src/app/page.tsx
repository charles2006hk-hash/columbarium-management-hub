    ...
    <div className="min-h-screen bg-stone-100 font-sans selection:bg-amber-700 selection:text-white scroll-smooth overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center mt-20 w-full max-w-4xl">
          ...
          {/* 針對手機縮小字體 (text-4xl)，電腦版維持 (md:text-7xl) */}
      ...
      {/* 歷史源起 */}
      <section id="history" className="py-20 md:py-32 bg-stone-200 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12 md:gap-16">
          <div className="w-full md:w-5/12 flex justify-center">
            <div className="p-6 md:p-12 bg-stone-900 border-4 border-double border-amber-700 shadow-2xl relative">
              ...
              <div 
                className="text-amber-500 font-serif font-bold text-xl md:text-3xl tracking-[0.3em] leading-loose h-48 md:h-80"
          ...
          <div className="w-full md:w-7/12">
            ...
            <h2 className="text-2xl md:text-4xl font-serif font-bold text-stone-900 mb-6 md:mb-8 tracking-widest leading-snug">
              「六一八」劫後祥瑞<br/>觀塘街坊的永恆守護
            </h2>
            <div className="space-y-4 md:space-y-6 text-stone-600 leading-loose text-justify text-sm md:text-lg font-light">
              ...
              <p>災後，政府撥地重建，古廟自此擴展。半世紀以來，地藏王古廟不僅是觀塘區的信仰核心，更是以佛法大願——<strong className="text-stone-900">「地獄不空，誓不成佛」</strong>，超渡救濟無數先靈。我們延續這份慈悲，為家屬提供莊嚴的祿位與法事服務。</p>
            </div>
          </div>
        </div>
      </section>

      {/* 🌟 2. 祿位園區：修復浪費空間 (手機一行2個) */}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 md:gap-10">
            {[
              ...
              <div key={i} className="group relative bg-stone-900 p-1 rounded-sm overflow-hidden hover:-translate-y-1 md:hover:-translate-y-2 transition-transform duration-500 shadow-2xl">
                ...
                {/* 內部 Padding 在手機端縮小 (p-4)，電腦端維持 (md:p-10) */}
      ...
      {/* 數位服務與法事查詢 */}
      <section id="services" className="py-20 md:py-32 bg-stone-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 flex flex-col-reverse lg:flex-row items-center gap-12 md:gap-20">
          <div className="w-full lg:w-1/2 relative mt-8 lg:mt-0">
            ...
            <div className="relative bg-white p-3 md:p-4 shadow-2xl border border-stone-200">
              <div className="border border-amber-200 bg-stone-50 p-6 md:p-8 flex flex-col h-[400px] md:h-[500px] relative overflow-hidden">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-2xl md:text-4xl font-serif font-bold text-stone-900 mb-6 md:mb-8 leading-snug tracking-widest">
              遠距追思<br/>法事圓滿隨時掌握
            </h2>
            <p className="text-stone-600 mb-8 md:mb-10 leading-loose font-light text-sm md:text-lg">
            ...
            <Link 
              href="/portal" 
              className="inline-flex items-center gap-4 px-6 py-3 md:px-8 md:py-4 bg-stone-900 text-amber-500 border border-stone-900 hover:bg-transparent hover:text-stone-900 transition-colors font-bold tracking-widest text-sm md:text-base"
            >
      ...
      {/* 預約參觀表單 */}
      <section id="contact" className="py-20 md:py-32 bg-stone-900 relative">
          ...
          <div className="bg-stone-950 border border-stone-800 shadow-2xl flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-5/12 p-8 md:p-12 bg-[url('https://www.transparenttextures.com/patterns/black-scales.png')] relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-stone-400 leading-relaxed mb-8 md:mb-12 font-light text-justify text-sm md:text-base">
